...
bulk fetches their XML files from medRxiv, and converts them to markdown.
...
class MissingFulltextUpdater:
    """Process all medRxiv records without fulltext, download XML and convert to markdown."""
    ...
    def process_record(self, record: Dict[str, Any]) -> Tuple[str, bool, str]:
        """
        Process a single record: download XML and convert to markdown.
        ...
        try:
            ...
            if 'xml' not in download_result:
                return doi, False, "Failed to download XML"
