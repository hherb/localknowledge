...
class EmbeddingDatabaseManager(DatabaseManager):
    ...
    def create_tables(self) -> None:
        ...
        try:
            self.execute("CREATE EXTENSION IF NOT EXISTS vector", commit=True)
    ...
    def create_indices(self) -> None:
        ...
        self.execute("CREATE INDEX IF NOT EXISTS idx_embeddings_source_id ON embeddings(source_id)", commit=True)
        self.execute("CREATE INDEX IF NOT EXISTS idx_embeddings_document_id ON embeddings(document_id)", commit=True)
