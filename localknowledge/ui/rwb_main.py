...
class MainWindow(QMainWindow):
    ...
    def restore_window_state(self):
        ...
        # Don't restore splitter sizes - let it use the default from setup
        # This prevents interference with the simple splitter functionality

        # Skip complex splitter state restoration to keep it simple

        # Keep it simple - no complex button state management
