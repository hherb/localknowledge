#!/usr/bin/env python3
"""
Test script for the DocumentListWidget with KnowledgeBrowser.

This script creates a simple application to test the DocumentListWidget
with sample data from the KnowledgeBrowser.
"""
...
class TestWindow(QMainWindow):
    """Test window for the DocumentListWidget with KnowledgeBrowser data."""
    
    def __init__(self):
        """Initialize the test window."""
        super().__init__()
        self.setWindowTitle("Document List Widget Test (KnowledgeBrowser)")
        ...
        # Add label
        label = QLabel("Document List Widget Test (KnowledgeBrowser)")
    ...
    def add_sample_data(self):
        ...
        # Sample documents with bookmark information
        documents = [
            {
                'id': 1,
                'source_id': 1,  # PubMed
            ...
            },
            {
                ...
                'title': 'Another medRxiv Preprint with No Bookmark',
    ...
    def on_document_selected(self, document):
        ...
        print(f"Bookmark type: {document.get('bookmark_type', 'None')}")
