#!/usr/bin/env python3
"""
Test script for the semantic search functionality in DocumentSearchManager.
"""
...
def test_semantic_search(question: str,
    ...
    """
    print("\n" + "="*80)
    print(f"Testing semantic search with:")
    ...
    # Get the generator
    result_generator = search_manager.semantic(
        question=question,
